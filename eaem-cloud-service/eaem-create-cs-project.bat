...
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.2.1:generate -D archetypeGroupId=com.adobe.aem -D archetypeArtifactId=aem-project-archetype -D archetypeVersion=51 -D aemVersion="cloud" -D appTitle="ADP AEM Cloud Services" -D appId="adp" -D groupId="com.wmt" -D frontendModule=general -D includeExamples=n -D includeErrorHandler=y -D includeDispatcherConfig=y
