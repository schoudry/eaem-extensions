...
mvn -B org.apache.maven.plugins:maven-archetype-plugin:3.2.1:generate -D archetypeGroupId=com.adobe.aem -D archetypeArtifactId=aem-project-archetype -D archetypeVersion=50 -D aemVersion="cloud" -D appTitle="Experience AEM CF to RTF to InDesign" -D appId="eaem-cf-html-rtf-indesign" -D groupId="apps.experienceaem" -D frontendModule=none -D includeExamples=n -D includeDispatcherConfig=n
