(function(){
    ...
    ExperienceAEM.ColorPickerDialog = new Class({
        ...
        apply: function() {
            ...
            var $selection = picker.$element.find(".colorpicker-holder").find(".selection");
            ...
            picker.$element.removeAttr("value");
    ...
    ExperienceAEM.TouchUIColorPickerPlugin = new Class({
        ...
        execute: function(id, value, envOptions) {
            ...
            this.dialog.restoreSelectionOnHide = false;
            ...
            if(!this.dialog.colorPicker){
                ...
                var $element = $('[data-rte-dialog="' + ExperienceAEM.TCP_DIALOG + '"] .coral-ColorPicker'),
                    $colorPicker = $element.data("colorpicker"),
                    options = {
                        element : $element,
                        config : {
                            colors: colors,
                ...
                //create or set the picker
                this.dialog.colorPicker = _.isEmpty($colorPicker) ? new CUI.Colorpicker(options)
                                                : $colorPicker;
            }
    ...
    ExperienceAEM.ColorPickerCmd = new Class({
        ...
        execute: function(execDef) {
            ...
            /*var $pickerButton = $('[data-rte-dialog="touchuicolorpickerdialog"]').find(".coral-ColorPicker-button");
            $pickerButton.nextAll().remove();*/
        },
