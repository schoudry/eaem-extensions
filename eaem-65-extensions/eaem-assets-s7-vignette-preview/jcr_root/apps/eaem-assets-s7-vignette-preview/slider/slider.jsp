...
<div style="text-align: right; width: 100%; margin: 0 0 15px 0">
    <input is="coral-textfield" placeholder="150" name="<%=name%>Input" value="150" style="width: 50px; margin-right: 10px">
    <button is="coral-button" id="<%=name%>Copy" iconsize="S" variant="primary">copy</button>
</div>